...
(AQ_KEYBOARD)
    ...
    (AQ_KEYBOARD_LOOP)
        ...
        //=======================================================
        //IS NOT SAVING THE VALUE... 
        @aq_counter
        D=M // Get counter value
        A=D // RAM[counter]
        //HERE IS THE PROBLEM... How do I set the RAM[counter] to KBD?
        @aq_pressed
        M=D // RAM[counter] = KBD 
        ...
        // GIVE A NUMBER BIGGER THAN 0 WHEN PRESSED
        @ge_output_1
...
@END //==============TAKE END OFF WHEN INPUT IS WORKING===========
0;JMP//===========================================================
